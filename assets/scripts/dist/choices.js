...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Choices = function () {
	  ...
	  _createClass(Choices, [{
	    ...
	    key: 'mapChoiceByValue',
	    value: function mapChoiceByValue(value, mapper) {
	      var _this13 = this;

	      this.store.getChoices().filter(function (choice) {
	        return choice.value === value;
	      }).map(function (choice) {
	        var mappedChoice = mapper({
	          value: choice.value,
	          label: choice.label,
	        ...
	        _this13.store.dispatch((0, _index3.changeChoice)(choice.value, choice.label, choice.disabled, choice.customProperties));
	      });
	      return this;
	    }
	    ...
	    value: function ajax(fn) {
	      ...
	      requestAnimationFrame(function () {
	        return _this14._handleLoadingState(true);
	      });
	      // Run callback
	    ...
	    value: function _onKeyDown(e) {
	      ...
	      var onEnterKey = function onEnterKey() {
	        ...
	        } else if (_this17.isSelectOneElement && !hasActiveDropdown) {
	    ...
	    value: function _createTemplates() {
	      ...
	      var templates = {
	        containerOuter: function containerOuter(direction) {
	          var tabIndex = _this23.isSelectOneElement ? 'tabindex="0"' : '';
	          var role = _this23.isSelectElement ? 'role="listbox"' : '';
	          var ariaAutoComplete = '';

	          if (_this23.isSelectElement && _this23.config.searchEnabled) {
	            role = 'role="combobox"';
	        ...
	        choiceList: function choiceList() {
	          var ariaMultiSelectable = !_this23.isSelectOneElement ? 'aria-multiselectable="true"' : '';
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.clearAll = exports.addGroup = exports.clearChoices = exports.activateChoices = exports.filterChoices = exports.changeChoice = exports.addChoice = exports.highlightItem = exports.removeItem = exports.addItem = undefined;
	...
	var changeChoice = exports.changeChoice = function changeChoice(choiceId, value, label, disabled, customProperties) {
	  return {
	    type: 'CHANGE_CHOICE',
	    value: value,
	    label: label,
